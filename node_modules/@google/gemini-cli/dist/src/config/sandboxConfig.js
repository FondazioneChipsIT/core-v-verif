...
function getSandboxCommand(sandbox) {
    ...
    if (typeof sandbox === 'string' && sandbox) {
        ...
        if (sandbox === 'runsc' && os.platform() !== 'linux') {
            throw new FatalSandboxError('gVisor (runsc) sandboxing is only supported on Linux');
        }
        ...
        if (sandbox === 'runsc' && !commandExists.sync('docker')) {
            throw new FatalSandboxError("runsc (gVisor) requires Docker. Install Docker, or use sandbox: 'docker'.");
        }
        return sandbox;
    }
