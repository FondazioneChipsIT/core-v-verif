...
describe('Extension Update Logic', () => {
    ...
    describe('updateExtension', () => {
        ...
        it('should migrate source if migratedTo is set and an update is available', async () => {
            ...
            await updateExtension(extensionWithMigratedTo, mockExtensionManager, ExtensionUpdateState.UPDATE_AVAILABLE, mockDispatch);
            expect(checkForExtensionUpdate).toHaveBeenCalledWith(expect.objectContaining({
                installMetadata: expect.objectContaining({
                    source: 'https://new-source.com/repo.git',
                }),
            }), mockExtensionManager);
            expect(mockExtensionManager.installOrUpdateExtension).toHaveBeenCalledWith(expect.objectContaining({
                source: 'https://new-source.com/repo.git',
            }), expect.anything());
        });
