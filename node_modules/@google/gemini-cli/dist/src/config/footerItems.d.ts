...
export declare const ALL_ITEMS: readonly [{
    ...
    readonly id: "quota";
    readonly header: "/stats";
    readonly description: "Remaining usage on daily limit (not shown when unavailable)";
}, {
...
export declare function deriveItemsFromLegacySettings(settings: MergedSettings): string[];
/**
