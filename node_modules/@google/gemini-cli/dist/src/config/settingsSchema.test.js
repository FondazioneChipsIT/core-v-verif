...
describe('SettingsSchema', () => {
    describe('getSettingsSchema', () => {
        ...
        it('should have gemmaModelRouter setting in schema', () => {
            ...
            expect(enabled.description).toBe('Enable the Gemma Model Router (experimental). Requires a local endpoint serving Gemma via the Gemini API using LiteRT-LM shim.');
