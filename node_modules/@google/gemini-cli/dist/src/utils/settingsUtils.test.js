...
TEST_ONLY, isInSettingsScope, getDisplayValue, } from './settingsUtils.js';
    ...
    describe('Schema Utilities', () => {
        ...
        describe('getEffectiveValue', () => {
            ...
            it('should handle nested settings correctly', () => {
                ...
                const value = getEffectiveValue('ui.accessibility.enableLoadingPhrases', settings);
    ...
    describe('Business Logic Utilities', () => {
        describe('isInSettingsScope', () => {
            ...
            it('should return true for nested settings that exist', () => {
                ...
                expect(isInSettingsScope('ui.accessibility.enableLoadingPhrases', settings)).toBe(true);
            });
            it('should return false for nested settings that do not exist', () => {
                const settings = makeMockSettings({});
                expect(isInSettingsScope('ui.accessibility.enableLoadingPhrases', settings)).toBe(false);
            });
        ...
        describe('getDisplayValue', () => {
            describe('enum behavior', () => {
                ...
                it('handles default values for number-based enums', () => {
                    ...
                    const result = getDisplayValue('ui.theme', makeMockSettings({}), makeMockSettings({}));
                    expect(result).toBe('Three');
                });
            ...
            it('should display objects as JSON strings, not "[object Object]"', () => {
                ...
                const emptyResult = getDisplayValue('experimental.gemmaModelRouter', emptySettings, emptySettings);
                ...
                const result = getDisplayValue('experimental.gemmaModelRouter', settings, settings);
        ...
        describe('getDisplayValue with units', () => {
            it('should format percentage correctly when unit is %', () => {
                ...
                const result = getDisplayValue('model.compressionThreshold', settings, makeMockSettings({}));
            ...
            it('should append unit for non-% units', () => {
                ...
                const result = getDisplayValue('ui.pollingInterval', settings, makeMockSettings({}));
