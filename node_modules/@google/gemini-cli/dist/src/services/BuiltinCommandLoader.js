...
import { isNightly, startupProfiler, getAdminErrorMessage, AuthType, } from '@google/gemini-cli-core';
...
export class BuiltinCommandLoader {
    ...
    async loadCommands(_signal) {
        ...
        const addDebugToChatResumeSubCommands = (subCommands) => {
            if (!subCommands) {
                return subCommands;
            }
        ...
        const chatResumeSubCommands = addDebugToChatResumeSubCommands(chatCommand.subCommands);
