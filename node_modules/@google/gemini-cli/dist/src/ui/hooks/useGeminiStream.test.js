...
import { CoreToolCallStatus, ApprovalMode, AuthType, GeminiEventType as ServerGeminiEventType, ToolErrorType, ToolConfirmationOutcome, MessageBusType, tokenLimit, debugLogger, coreEvents, CoreEvent, MCPDiscoveryState, GeminiCliOperation, getPlanModeExitMessage, } from '@google/gemini-cli-core';
...
describe('useGeminiStream', () => {
    ...
    const renderTestHook = (initialToolCalls = [], geminiClient, loadedSettings = mockLoadedSettings) => {
