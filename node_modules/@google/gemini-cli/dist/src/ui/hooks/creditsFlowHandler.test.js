...
import { makeFakeConfig, getG1CreditBalance, shouldAutoUseCredits, shouldShowOverageMenu, shouldShowEmptyWalletMenu, shouldLaunchBrowser, logBillingEvent, G1_CREDIT_TYPE, UserTierId, } from '@google/gemini-cli-core';
...
describe('handleCreditsFlow', () => {
    ...
    let isDialogPending;
    let mockSetOverageMenuRequest;
    let mockSetEmptyWalletRequest;
...
//# sourceMappingURL=creditsFlowHandler.test.js.map