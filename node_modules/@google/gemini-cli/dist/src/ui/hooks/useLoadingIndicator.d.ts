...
export declare const useLoadingIndicator: ({ streamingState, shouldShowFocusHint, retryStatus, loadingPhrasesMode, customWittyPhrases, errorVerbosity, }: UseLoadingIndicatorProps) => {
    elapsedTime: number;
