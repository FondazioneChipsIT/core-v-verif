...
import { SlashCommandStatus, MCPDiscoveryState, makeFakeConfig, coreEvents, } from '@google/gemini-cli-core';
...
describe('useSlashCommandProcessor', () => {
    ...
    describe('Command Precedence', () => {
        ...
        it('should add an overridden command to the history', async () => {
            ...
            const exitCommand = createTestCommand({ name: 'exit', action: vi.fn() }, CommandKind.USER_FILE);
            const result = await setupProcessorHook({
                builtinCommands: [quitCommand],
                fileCommands: [exitCommand],
            });
