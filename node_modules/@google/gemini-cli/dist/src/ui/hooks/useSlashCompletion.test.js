...
describe('useSlashCompletion', () => {
    ...
    describe('Top-Level Commands', () => {
        ...
        it('should show the same selectable auto/checkpoint menu for /chat and /resume', async () => {
            ...
            const { result: chatResult, unmount: unmountChat } = renderHook(() => useTestHarnessForSlashCompletion(true, '/chat', slashCommands, mockCommandContext));
            await waitFor(() => {
            ...
            const { result: resumeResult, unmount: unmountResume } = renderHook(() => useTestHarnessForSlashCompletion(true, '/resume', slashCommands, mockCommandContext));
            await waitFor(() => {
        ...
        it('should show the grouped /resume menu for unique /resum prefix input', async () => {
            ...
            const { result, unmount } = renderHook(() => useTestHarnessForSlashCompletion(true, '/resum', slashCommands, mockCommandContext));
            await waitFor(() => {
                ...
                expect(result.current.suggestions.slice(1).map((s) => s.label)).toEqual(expect.arrayContaining(['list', 'save']));
            });
            unmount();
        });
