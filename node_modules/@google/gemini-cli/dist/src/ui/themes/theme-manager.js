...
import { createCustomTheme, validateCustomTheme, interpolateColor, getThemeTypeFromBackgroundColor, resolveColor, } from './theme.js';
import { DEFAULT_BACKGROUND_OPACITY, DEFAULT_INPUT_BACKGROUND_OPACITY, DEFAULT_SELECTION_OPACITY, DEFAULT_BORDER_OPACITY, } from '../constants.js';
...
class ThemeManager {
    ...
    hasExtensionThemes(extensionName) {
        return Array.from(this.extensionThemes.keys()).some((name) => name.endsWith(`(${extensionName})`));
    }
    /**
