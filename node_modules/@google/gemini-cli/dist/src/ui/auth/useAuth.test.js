...
import { AuthType, ProjectIdRequiredError, } from '@google/gemini-cli-core';
...
describe('useAuth', () => {
    ...
    describe('useAuthCommand', () => {
        ...
        it('should handle ProjectIdRequiredError without "Failed to login" prefix', async () => {
            ...
            mockConfig.refreshAuth.mockRejectedValue(projectIdError);
            const { result } = renderHook(() => useAuthCommand(createSettings(AuthType.LOGIN_WITH_GOOGLE), mockConfig));
            await waitFor(() => {
                expect(result.current.authError).toBe('This account requires setting the GOOGLE_CLOUD_PROJECT or GOOGLE_CLOUD_PROJECT_ID env var. See https://goo.gle/gemini-cli-auth-docs#workspace-gca');
