...
describe('AuthInProgress', () => {
    ...
    it('renders initial state with spinner', async () => {
        const { lastFrame, waitUntilReady, unmount } = render(_jsx(AuthInProgress, { onTimeout: onTimeout }));
    ...
    it('calls onTimeout when ESC is pressed', async () => {
        const { waitUntilReady, unmount } = render(_jsx(AuthInProgress, { onTimeout: onTimeout }));
        await waitUntilReady();
