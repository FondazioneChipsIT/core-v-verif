...
export const AppContainer = (props) => {
    ...
    useEffect(() => {
        ...
        registerCleanup(async () => {
            ...
            await Promise.all(Array.from(backgroundShellsRef.current.keys()).map((pid) => ShellExecutionService.kill(pid)));
...
----------------------------------------------------------------
    ...
    const availableTerminalHeight = Math.max(0, terminalHeight - controlsHeight - backgroundShellHeight - 1);
