...
const RenderListItemInternal = ({ itemText, type, marker, leadingWhitespace = '', }) => {
    ...
    return (_jsxs(Box, { paddingLeft: indentation + LIST_ITEM_PREFIX_PADDING, flexDirection: "row", children: [_jsx(Box, { width: prefixWidth, flexShrink: 0, children: _jsx(Text, { color: listResponseColor, children: prefix }) }), _jsx(Box, { flexGrow: LIST_ITEM_TEXT_FLEX_GROW, children: _jsx(Text, { wrap: "wrap", color: listResponseColor, children: _jsx(RenderInline, { text: itemText, defaultColor: listResponseColor }) }) })] }));
};
