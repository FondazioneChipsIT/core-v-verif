 ...
 */
export const SHELL_CONTENT_OVERHEAD = TOOL_RESULT_STATIC_HEIGHT + TOOL_RESULT_STANDARD_RESERVED_LINE_COUNT;
/**
...
export function calculateToolContentMaxLines(options) {
    ...
    let contentHeight = availableTerminalHeight
        ? Math.max(availableTerminalHeight - TOOL_RESULT_STATIC_HEIGHT - reservedLines, TOOL_RESULT_MIN_LINES_SHOWN + 1)
        : undefined;
...
export function calculateShellMaxLines(options) {
    const { status, isAlternateBuffer, isThisShellFocused, availableTerminalHeight, constrainHeight, isExpandable, } = options;
...
//# sourceMappingURL=toolLayoutUtils.js.map