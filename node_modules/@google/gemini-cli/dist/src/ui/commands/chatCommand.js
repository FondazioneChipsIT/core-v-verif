...
const saveCommand = {
    name: 'save',
    description: 'Save the current conversation as a checkpoint. Usage: /resume save <tag>',
    kind: CommandKind.BUILT_IN,
    autoExecute: false,
...
const resumeCheckpointCommand = {
    name: 'resume',
    altNames: ['load'],
    description: 'Resume a conversation from a checkpoint. Usage: /resume resume <tag>',
    kind: CommandKind.BUILT_IN,
    autoExecute: true,
    action: async (context, args) => {
        const tag = args.trim();
...
const shareCommand = {
    name: 'share',
    description: 'Share the current conversation to a markdown or json file. Usage: /resume share <file>',
    kind: CommandKind.BUILT_IN,
    autoExecute: false,
    action: async (context, args) => {
...
export const checkpointSubCommands = [
    listCommand,
    saveCommand,
...
const checkpointCompatibilityCommand = {
    name: 'checkpoints',
    altNames: ['checkpoint'],
...
export const chatResumeSubCommands = [
