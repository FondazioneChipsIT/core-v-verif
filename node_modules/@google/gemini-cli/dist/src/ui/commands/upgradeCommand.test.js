...
import { AuthType, openBrowserSecurely, shouldLaunchBrowser, UPGRADE_URL_PAGE, } from '@google/gemini-cli-core';
...
describe('upgradeCommand', () => {
    ...
    it('should have the correct name and description', () => {
        ...
        expect(upgradeCommand.description).toBe('Upgrade your Gemini Code Assist tier for higher limits');
    });
    ...
    it('should return an error message when NOT logged in with Google', async () => {
        vi.mocked(mockContext.services.config.getContentGeneratorConfig).mockReturnValue({
    ...
    it('should return an error message if openBrowserSecurely fails', async () => {
        vi.mocked(openBrowserSecurely).mockRejectedValue(new Error('Failed to open'));
        if (!upgradeCommand.action) {
            throw new Error('The upgrade command must have an action.');
        }
        const result = await upgradeCommand.action(mockContext, '');
...
//# sourceMappingURL=upgradeCommand.test.js.map