...
describe('ToolConfirmationMessage', () => {
    ...
    it('should render multiline shell scripts with correct newlines and syntax highlighting (SVG snapshot)', async () => {
        ...
        const result = renderWithProviders(_jsx(ToolConfirmationMessage, { callId: "test-call-id", confirmationDetails: confirmationDetails, config: mockConfig, getPreferredEditor: vi.fn(), availableTerminalHeight: 30, terminalWidth: 80 }));
