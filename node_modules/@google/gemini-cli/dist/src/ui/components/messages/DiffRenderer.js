...
const renderDiffContent = (parsedLines, filename, tabWidth = DEFAULT_TAB_WIDTH, availableTerminalHeight, terminalWidth) => {
    ...
    const content = displayableLines.reduce((acc, line, index) => {
        ...
        if (lastLineNumber !== null &&
            ...
            acc.push(_jsx(Box, { children: _jsx(Box, { borderStyle: "double", borderLeft: false, borderRight: false, borderBottom: false, width: terminalWidth, borderColor: semanticTheme.text.secondary }) }, `gap-${index}`));
        }
