...
import { ShellExecutionService, CoreToolCallStatus, } from '@google/gemini-cli-core';
import { calculateShellMaxLines, calculateToolContentMaxLines, SHELL_CONTENT_OVERHEAD, } from '../../utils/toolLayoutUtils.js';
    ...
    React.useEffect(() => {
        ...
        if (isExecuting && ptyId) {
            try {
                ...
                const finalHeight = availableHeight ?? ACTIVE_SHELL_MAX_LINES - SHELL_CONTENT_OVERHEAD;
                ShellExecutionService.resizePty(ptyId, Math.max(1, childWidth), Math.max(1, finalHeight));
            }
            catch (e) {
