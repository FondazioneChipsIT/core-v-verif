...
describe('<ShellToolMessage />', () => {
    ...
    describe('interactive shell focus', () => {
        it.each([
            ...
            const { lastFrame, simulateClick, unmount } = renderShell({ name }, { mouseEventsEnabled: true });
            await waitFor(() => {
        ...
        it('resets focus when shell finishes', async () => {
            ...
            const { lastFrame, unmount } = renderWithProviders(_jsx(Wrapper, {}), {
                uiActions,
                uiState: {
    ...
    describe('Snapshots', () => {
        it.each([
            ...
            const { lastFrame, waitUntilReady, unmount } = renderShell(props, options);
    ...
    describe('Height Constraints', () => {
        ...
        ])('%s', async (_, availableTerminalHeight, expectedMaxLines, focused, constrainHeight) => {
