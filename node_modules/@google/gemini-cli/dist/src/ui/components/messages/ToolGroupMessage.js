...
export const ToolGroupMessage = ({ item, toolCalls: allToolCalls, availableTerminalHeight, terminalWidth, borderTop: borderTopOverride, borderBottom: borderBottomOverride, isExpandable, }) => {
    ...
    const { activePtyId, embeddedShellFocused, backgroundShells, pendingHistoryItems, } = useUIState();
      ...
      */
        width: terminalWidth, paddingRight: TOOL_MESSAGE_HORIZONTAL_MARGIN, children: [visibleToolCalls.map((tool, index) => {
            ...
            /*
               ...
               */
            (visibleToolCalls.length > 0 || borderBottomOverride !== undefined) && (_jsx(Box, { height: 0, width: contentWidth, borderLeft: true, borderRight: true, borderTop: false, borderBottom: borderBottomOverride ?? true, borderColor: borderColor, borderDimColor: borderDimColor, borderStyle: "round" }))] }));
    return content;
};
