...
const renderWithMockedStats = async (metrics, width, currentModel = 'gemini-2.5-pro') => {
    ...
    const result = render(_jsx(ModelStatsDisplay, { currentModel: currentModel }), width);
...
describe('<ModelStatsDisplay />', () => {
    ...
    it('should render user identity information when provided', async () => {
        ...
        const { lastFrame, waitUntilReady, unmount } = render(_jsx(ModelStatsDisplay, { selectedAuthType: "oauth", userEmail: "test@example.com", tier: "Pro" }));
