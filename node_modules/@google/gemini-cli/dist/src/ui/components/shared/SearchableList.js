 ...
 */
export function SearchableList({ title, items, onSelect, onClose, searchPlaceholder = 'Search...', renderItem, header, footer, maxItemsToShow = 10, useSearch, onSearch, resetSelectionOnItemsChange = false, isFocused = true, }) {
    ...
    return (_jsxs(Box, { flexDirection: "column", width: "100%", height: "100%", paddingX: 1, children: [title && (_jsx(Box, { marginBottom: 1, children: _jsx(Text, { bold: true, color: theme.text.primary, children: title }) })), searchBuffer && (_jsx(Box, { borderStyle: "round", borderColor: theme.border.default, paddingX: 1, marginBottom: 1, children: _jsx(TextInput, { buffer: searchBuffer, placeholder: searchPlaceholder, focus: isFocused }) })), header && _jsx(Box, { marginBottom: 1, children: header }), _jsx(Box, { flexDirection: "column", flexGrow: 1, children: filteredItems.length === 0 ? (_jsx(Box, { marginX: 2, children: _jsx(Text, { color: theme.text.secondary, children: "No items found." }) })) : (_jsxs(_Fragment, { children: [filteredItems.length > maxItemsToShow && (_jsx(Box, { marginX: 1, children: _jsx(Text, { color: theme.text.secondary, children: "\u25B2" }) })), visibleItems.map((item, index) => {
