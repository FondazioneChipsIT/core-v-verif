 ...
 */
export declare function SlicingMaxSizedBox<T>({ data, maxLines, isAlternateBuffer, children, ...boxProps }: SlicingMaxSizedBoxProps<T>): import("react/jsx-runtime").JSX.Element;
