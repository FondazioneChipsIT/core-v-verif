 ...
 */
export declare function SearchableList<T extends GenericListItem>({ title, items, onSelect, onClose, searchPlaceholder, renderItem, header, footer, maxItemsToShow, useSearch, onSearch, resetSelectionOnItemsChange, isFocused, }: SearchableListProps<T>): React.JSX.Element;
