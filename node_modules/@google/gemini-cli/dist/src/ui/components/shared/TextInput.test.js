...
describe('TextInput', () => {
    ...
    it('renders with an initial value', async () => {
        ...
        const { lastFrame, waitUntilReady, unmount } = render(_jsx(TextInput, { buffer: buffer, onSubmit: onSubmit, onCancel: onCancel }));
    ...
    it('renders a placeholder', async () => {
        ...
        const { lastFrame, waitUntilReady, unmount } = render(_jsx(TextInput, { buffer: buffer, placeholder: "testing", onSubmit: onSubmit, onCancel: onCancel }));
        await waitUntilReady();
        expect(lastFrame()).toContain('testing');
        unmount();
    });
    it('handles character input', async () => {
        const { waitUntilReady, unmount } = render(_jsx(TextInput, { buffer: mockBuffer, onSubmit: onSubmit, onCancel: onCancel }));
        await waitUntilReady();
    ...
    it('calls onCancel on escape', async () => {
        vi.useFakeTimers();
        const { waitUntilReady, unmount } = render(_jsx(TextInput, { buffer: mockBuffer, onCancel: onCancel, onSubmit: onSubmit }));
        await waitUntilReady();
        const keypressHandler = mockedUseKeypress.mock.calls[0][0];
        await act(async () => {
            keypressHandler({
    ...
    it('renders the input value', async () => {
        ...
        const { lastFrame, waitUntilReady, unmount } = render(_jsx(TextInput, { buffer: mockBuffer, onSubmit: onSubmit, onCancel: onCancel }));
        await waitUntilReady();
    ...
    it('does not show cursor when not focused', async () => {
        mockBuffer.setText('test');
        const { lastFrame, waitUntilReady, unmount } = render(_jsx(TextInput, { buffer: mockBuffer, focus: false, onSubmit: onSubmit, onCancel: onCancel }));
        await waitUntilReady();
