...
import { PREVIEW_GEMINI_MODEL, PREVIEW_GEMINI_3_1_MODEL, PREVIEW_GEMINI_FLASH_MODEL, PREVIEW_GEMINI_3_1_FLASH_LITE_MODEL, PREVIEW_GEMINI_MODEL_AUTO, DEFAULT_GEMINI_MODEL, DEFAULT_GEMINI_FLASH_MODEL, DEFAULT_GEMINI_FLASH_LITE_MODEL, DEFAULT_GEMINI_MODEL_AUTO, ModelSlashCommandEvent, logModelSlashCommand, getDisplayString, AuthType, PREVIEW_GEMINI_3_1_CUSTOM_TOOLS_MODEL, isProModel, UserTierId, } from '@google/gemini-cli-core';
...
export function ModelDialog({ onClose }) {
    ...
    const [hasAccessToProModel, setHasAccessToProModel] = useState(() => !(config?.getProModelNoAccessSync() ?? false));
    const [view, setView] = useState(() => config?.getProModelNoAccessSync() ? 'manual' : 'main');
