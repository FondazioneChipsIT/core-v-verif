...
import { ApprovalMode, validatePlanPath, validatePlanContent, QuestionType, processSingleFileContent, debugLogger, } from '@google/gemini-cli-core';
...
export const ExitPlanModeDialog = ({ planPath, onApprove, onFeedback, onCancel, getPreferredEditor, width, availableHeight, }) => {
    ...
    const handleOpenEditor = useCallback(async () => {
        try {
            ...
            onFeedback('I have edited the plan or annotated it with feedback. Review the edited plan, update if necessary, and present it again for approval.');
            refresh();
        }
        catch (err) {
    ...
    return (_jsx(Box, { flexDirection: "column", width: width, children: _jsx(AskUserDialog, { questions: [
            ...
            }, onCancel: onCancel, width: width, availableHeight: availableHeight, extraParts: [`${editHint} to edit plan`] }) }));
};
