...
export const DialogManager = ({ addItem, terminalWidth, }) => {
    ...
    if (uiState.isSettingsDialogOpen) {
        return (_jsx(Box, { flexDirection: "column", children: _jsx(SettingsDialog, { onSelect: () => uiActions.closeSettingsDialog(), onRestartRequest: relaunchApp, availableTerminalHeight: terminalHeight - staticExtraHeight }) }));
    }
    ...
    if (uiState.isAgentConfigDialogOpen &&
        ...
        return (_jsx(Box, { flexDirection: "column", children: _jsx(AgentConfigDialog, { agentName: uiState.selectedAgentName, displayName: uiState.selectedAgentDisplayName, definition: uiState.selectedAgentDefinition, settings: settings, availableTerminalHeight: terminalHeight - staticExtraHeight, onClose: uiActions.closeAgentConfigDialog, onSave: async () => {
