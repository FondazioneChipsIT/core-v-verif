...
describe('RewindViewer', () => {
    ...
    describe('Screen Reader Accessibility', () => {
        ...
        it('renders the rewind viewer with conversation items', async () => {
            ...
            const { lastFrame, waitUntilReady, unmount } = renderWithProviders(_jsx(RewindViewer, { conversation: conversation, onExit: vi.fn(), onRewind: vi.fn() }));
    ...
    describe('Rendering', () => {
        it.each([
            ...
            const { lastFrame, waitUntilReady, unmount } = renderWithProviders(_jsx(RewindViewer, { conversation: conversation, onExit: onExit, onRewind: onRewind }));
            await waitUntilReady();
    ...
    it('updates selection and expansion on navigation', async () => {
        ...
        const onExit = vi.fn();
        const onRewind = vi.fn();
        const { lastFrame, stdin, waitUntilReady, unmount } = renderWithProviders(_jsx(RewindViewer, { conversation: conversation, onExit: onExit, onRewind: onRewind }));
        await waitUntilReady();
        // Initial state
    ...
    describe('Navigation', () => {
        it.each([
            ...
            const { lastFrame, stdin, waitUntilReady, unmount } = renderWithProviders(_jsx(RewindViewer, { conversation: conversation, onExit: vi.fn(), onRewind: vi.fn() }));
            await waitUntilReady();
            act(() => {
        ...
        it.each([
            {
                ...
                actionStep: async (stdin, lastFrame, waitUntilReady) => {
            ...
            const onRewind = vi.fn();
            const { lastFrame, stdin, waitUntilReady, unmount } = renderWithProviders(_jsx(RewindViewer, { conversation: conversation, onExit: vi.fn(), onRewind: onRewind }));
            await waitUntilReady();
            // Select
            await act(async () => {
    ...
    it('updates content when conversation changes (background update)', async () => {
        ...
        const { lastFrame: lastFrame2, waitUntilReady: waitUntilReady2, unmount: unmount2, } = renderWithProviders(_jsx(RewindViewer, { conversation: conversation, onExit: onExit, onRewind: onRewind }));
