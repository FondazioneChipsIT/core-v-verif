...
import { ToolCallDecision, getShellConfiguration, } from '@google/gemini-cli-core';
...
const renderWithMockedStats = async (metrics, sessionId = 'test-session') => {
...
describe('<SessionSummaryDisplay />', () => {
    ...
    describe('Session ID escaping', () => {
        it('renders a standard UUID-formatted session ID in the footer (bash)', async () => {
            ...
            const { lastFrame, unmount } = await renderWithMockedStats(emptyMetrics, uuidSessionId);
            const output = lastFrame();
        ...
        it('sanitizes a malicious session ID in the footer (bash)', async () => {
            ...
            const { lastFrame, unmount } = await renderWithMockedStats(emptyMetrics, maliciousSessionId);
            const output = lastFrame();
