...
import { MIN_TERMINAL_WIDTH_FOR_FULL_LABEL, DEFAULT_COMPRESSION_THRESHOLD, } from '../constants.js';
export const ContextUsageDisplay = ({ promptTokenCount, model, terminalWidth, }) => {
    ...
    const threshold = settings.merged.model?.compressionThreshold ??
    ...
    return (_jsxs(Text, { color: textColor, children: [percentageUsed, label] }));
};
