...
export function AgentConfigDialog({ agentName, displayName, definition, settings, onClose, onSave, availableTerminalHeight, }) {
    ...
    return (_jsx(BaseSettingsDialog, { title: `Configure: ${displayName}`, searchEnabled: false, items: items, showScopeSelector: true, selectedScope: selectedScope, onScopeChange: handleScopeChange, maxItemsToShow: maxItemsToShow, availableHeight: availableTerminalHeight, maxLabelWidth: maxLabelWidth, onItemToggle: handleItemToggle, onEditCommit: handleEditCommit, onItemClear: handleItemClear, onClose: onClose, footer: modifiedFields.size > 0
            ? {
                content: (_jsx(Text, { color: theme.text.secondary, children: "Changes saved automatically." })),
                height: 1,
            }
            : undefined }));
}
