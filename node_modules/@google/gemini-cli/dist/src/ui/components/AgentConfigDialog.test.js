...
describe('AgentConfigDialog', () => {
    ...
    describe('existing overrides', () => {
        ...
        it('should respond to availableTerminalHeight and truncate list', async () => {
            ...
            const { lastFrame, unmount } = render(_jsx(KeypressProvider, { children: _jsx(AgentConfigDialog, { agentName: "test-agent", displayName: "Test Agent", definition: createMockAgentDefinition(), settings: settings, onClose: mockOnClose, onSave: mockOnSave, availableTerminalHeight: 20 }) }));
