...
export const Composer = ({ isFocused = true }) => {
    ...
    const shouldReserveSpaceForShortcutsHint = settings.merged.ui.showShortcutsHint && !hideShortcutsHintForSuggestions;
    const showShortcutsHint = shouldReserveSpaceForShortcutsHint && showShortcutsHintDebounced;
    ...
    return (_jsxs(Box, { flexDirection: "column", width: uiState.terminalWidth, flexGrow: 0, flexShrink: 0, children: [(!uiState.slashCommands ||
                ...
                uiState.isResuming) && (_jsx(ConfigInitDisplay, { message: uiState.isResuming ? 'Resuming session...' : undefined })), showUiDetails && (_jsx(QueuedMessageDisplay, { messageQueue: uiState.messageQueue })), showUiDetails && _jsx(TodoTray, {}), _jsxs(Box, { width: "100%", flexDirection: "column", children: [_jsxs(Box, { width: "100%", flexDirection: isNarrow ? 'column' : 'row', alignItems: isNarrow ? 'flex-start' : 'center', justifyContent: isNarrow ? 'flex-start' : 'space-between', children: [_jsx(Box, { marginLeft: 1, marginRight: isNarrow ? 0 : 1, flexDirection: "row", alignItems: isNarrow ? 'flex-start' : 'center', flexGrow: 1, children: showUiDetails && showLoadingIndicator && (_jsx(LoadingIndicator, { inline: true, thought: uiState.streamingState ===
                                        ...
                                        ? undefined
                                        : uiState.currentLoadingPhrase, thoughtLabel: inlineThinkingMode === 'full' ? 'Thinking...' : undefined, elapsedTime: uiState.elapsedTime })) }), _jsx(Box, { marginTop: isNarrow ? 1 : 0, flexDirection: "column", alignItems: isNarrow ? 'flex-start' : 'flex-end', minHeight: showUiDetails && shouldReserveSpaceForShortcutsHint ? 1 : 0, children: showUiDetails && showShortcutsHint && _jsx(ShortcutsHint, {}) })] }), showMinimalMetaRow && (_jsxs(Box, { justifyContent: "space-between", width: "100%", flexDirection: isNarrow ? 'column' : 'row', alignItems: isNarrow ? 'flex-start' : 'center', children: [_jsxs(Box, { marginLeft: 1, marginRight: isNarrow ? 0 : 1, flexDirection: "row", alignItems: isNarrow ? 'flex-start' : 'center', flexGrow: 1, children: [showMinimalInlineLoading && (_jsx(LoadingIndicator, { inline: true, thought: uiState.streamingState ===
                                            StreamingState.WaitingForConfirmation
                                            ? undefined
                                            : uiState.thought, currentLoadingPhrase: settings.merged.ui.loadingPhrases === 'off'
                                            ? undefined
                                            ...
                                            ? 1
                                            : 0, children: _jsx(ToastDisplay, {}) }))] }), (showMinimalContextBleedThrough ||
                                shouldReserveSpaceForShortcutsHint) && (_jsxs(Box, { marginTop: isNarrow && showMinimalBleedThroughRow ? 1 : 0, flexDirection: isNarrow ? 'column' : 'row', alignItems: isNarrow ? 'flex-start' : 'flex-end', minHeight: 1, children: [showMinimalContextBleedThrough && (_jsx(ContextUsageDisplay, { promptTokenCount: uiState.sessionStats.lastPromptTokenCount, model: uiState.currentModel, terminalWidth: uiState.terminalWidth })), _jsx(Box, { marginLeft: showMinimalContextBleedThrough && !isNarrow ? 1 : 0, marginTop: showMinimalContextBleedThrough && isNarrow ? 1 : 0, children: showShortcutsHint && _jsx(ShortcutsHint, {}) })] }))] })), showShortcutsHelp && _jsx(ShortcutsHelp, {}), showUiDetails && _jsx(HorizontalLine, {}), showUiDetails && (_jsxs(Box, { justifyContent: settings.merged.ui.hideContextSummary
                            ? 'flex-start'
