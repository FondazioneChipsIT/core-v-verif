...
describe('AboutBox', () => {
    ...
    it('renders with required props', async () => {
        const { lastFrame, waitUntilReady, unmount } = renderWithProviders(_jsx(AboutBox, { ...defaultProps }));
    ...
    it.each([
        ...
        const { lastFrame, waitUntilReady, unmount } = renderWithProviders(_jsx(AboutBox, { ...props }));
        await waitUntilReady();
        const output = lastFrame();
