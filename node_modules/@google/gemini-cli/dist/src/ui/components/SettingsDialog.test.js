...
const renderDialog = (settings, onSelect, options) => render(_jsx(SettingsContext.Provider, { value: settings, children: _jsx(KeypressProvider, { children: _jsx(SettingsDialog, { onSelect: onSelect, onRestartRequest: options?.onRestartRequest, availableTerminalHeight: options?.availableTerminalHeight }) }) }));
describe('SettingsDialog', () => {
    ...
    describe('String Settings Editing', () => {
        it('should allow editing and committing a string setting', async () => {
            ...
            const onSelect = vi.fn();
            const { stdin, unmount, rerender, waitUntilReady } = render(_jsx(SettingsContext.Provider, { value: settings, children: _jsx(KeypressProvider, { children: _jsx(SettingsDialog, { onSelect: onSelect }) }) }));
            await waitUntilReady();
            ...
            rerender(_jsx(SettingsContext.Provider, { value: settings, children: _jsx(KeypressProvider, { children: _jsx(SettingsDialog, { onSelect: onSelect }) }) }));
