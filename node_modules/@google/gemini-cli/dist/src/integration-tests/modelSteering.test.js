...
describe('Model Steering Integration', () => {
    ...
    it('should steer the model using a hint during a tool turn', async () => {
        const fakeResponsesPath = path.join(__dirname, '../test-utils/fixtures/steering.responses');
        rig = new AppRig({
            fakeResponsesPath,
        ...
        await rig.waitForOutput(/Since you want me to focus on .txt files,[\s\S]*I will read file1.txt/);
...
//# sourceMappingURL=modelSteering.test.js.map