...
describe('extensions uninstall command', () => {
    ...
    describe('handleUninstall', () => {
        ...
        it('should log a message if no extensions are installed and --all flag is used', async () => {
            ...
            expect(emitConsoleLog).toHaveBeenCalledWith('log', 'No extensions currently installed.');
            mockCwd.mockRestore();
        });
    ...
    describe('uninstallCommand', () => {
        ...
        describe('builder', () => {
            ...
            it('check function should throw for missing names and no --all flag', () => {
                ...
                expect(() => checkCallback({ names: [], all: false })).toThrow('Please include at least one extension name to uninstall as a positional argument, or use the --all flag.');
            });
