...
import { type MergedSettings, type LoadedSettings } from '../../config/settings.js';
...
export declare function listMcpServers(loadedSettingsArg?: LoadedSettings): Promise<void>;
interface ListArgs {
