...
describe('mcp list command', () => {
    ...
    beforeEach(() => {
        ...
        vi.spyOn(McpServerEnablementManager.prototype, 'isFileEnabled').mockResolvedValue(true);
    ...
    it('should display blocked status for servers in excluded list', async () => {
        ...
        await listMcpServers();
        expect(debugLogger.log).toHaveBeenCalledWith(expect.stringContaining('blocked-server: /test/server  (stdio) - Blocked'));
    ...
    it('should display disabled status for servers disabled via enablement manager', async () => {
        ...
        vi.spyOn(McpServerEnablementManager.prototype, 'isFileEnabled').mockResolvedValue(false);
        await listMcpServers();
        expect(debugLogger.log).toHaveBeenCalledWith(expect.stringContaining('disabled-server: /test/server  (stdio) - Disabled'));
        expect(mockedCreateTransport).not.toHaveBeenCalled();
    });
});
