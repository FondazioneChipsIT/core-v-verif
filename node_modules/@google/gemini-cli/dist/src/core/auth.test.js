...
import { ValidationRequiredError, ProjectIdRequiredError, AuthType, } from '@google/gemini-cli-core';
...
describe('auth', () => {
    ...
    it('should return ProjectIdRequiredError message without "Failed to login" prefix', async () => {
        ...
        const result = await performInitialAuth(mockConfig, AuthType.LOGIN_WITH_GOOGLE);
        expect(result).toEqual({
            authError: 'This account requires setting the GOOGLE_CLOUD_PROJECT or GOOGLE_CLOUD_PROJECT_ID env var. See https://goo.gle/gemini-cli-auth-docs#workspace-gca',
            accountSuspensionInfo: null,
        });
