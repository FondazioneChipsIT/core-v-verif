...
export class ReadManyFilesTool extends BaseDeclarativeTool {
    ...
    constructor(config, messageBus) {
        super(ReadManyFilesTool.Name, 'ReadManyFiles', READ_MANY_FILES_DEFINITION.base.description, Kind.Read, READ_MANY_FILES_DEFINITION.base.parametersJsonSchema, messageBus, true, // isOutputMarkdown
        false);
        this.config = config;
    }
