...
Response: ${truncateString(rawResponseText, 10000, '\n\n... [Error response truncated] ...')}`;
            ...
            if (lowContentType.includes('text/markdown') ||
                ...
                const text = truncateString(bodyBuffer.toString('utf8'), MAX_CONTENT_LENGTH, TRUNCATION_WARNING);
                return {
                    llmContent: text,
            ...
            if (lowContentType.includes('text/html')) {
                ...
                const textContent = truncateString(convert(html, {
                    wordwrap: false,
                    selectors: [
                        { selector: 'a', options: { ignoreHref: false, baseUrl: url } },
                    ],
                }), MAX_CONTENT_LENGTH, TRUNCATION_WARNING);
                return {
