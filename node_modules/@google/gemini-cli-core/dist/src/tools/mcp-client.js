...
export class McpClient {
    ...
    constructor(serverName, serverConfig, toolRegistry, promptRegistry, resourceRegistry, workspaceContext, cliConfig, debugMode, clientVersion, onContextUpdated) {
        ...
        try {
            do {
                ...
                try {
                    ...
                    const currentResources = this.resourceRegistry.getResourcesByServer(this.serverName) || [];
        ...
        try {
            do {
                ...
                try {
                    ...
                    // wait briefly and try one more time. Some servers notify before they're fully ready.
                    const currentPrompts = this.promptRegistry.getPromptsByServer(this.serverName) || [];
        ...
        try {
            do {
                ...
                try {
                    ...
                    // wait briefly and try one more time. Some servers notify before they're fully ready.
                    const currentTools = this.toolRegistry.getToolsByServer(this.serverName) || [];
