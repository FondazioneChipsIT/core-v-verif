                    ...
                    try {
                        ...
                        if ((isContentError && isGemini2Model(model)) ||
                            ...
                            if (attempt < maxAttempts - 1) {
                                ...
                                logContentRetry(this.config, new ContentRetryEvent(attempt, errorType, delayMs, model));
                        ...
                        logContentRetryFailure(this.config, new ContentRetryFailureEvent(attempt + 1, errorType, model));
                        throw error;
                    }
                }
            }
