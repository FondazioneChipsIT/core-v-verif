...
`);
    ...
    describe('Built-in Plan Mode Policy', () => {
        ...
        it('should override default subagent rules when in Plan Mode for unknown subagents', async () => {
            ...
            try {
                ...
                const checkResult = await engine.check({ name: 'unknown_subagent' }, undefined);
                ...
                const codebaseResult = await engine.check({ name: 'codebase_investigator' }, undefined);
                expect(codebaseResult.decision, 'codebase_investigator should be ALLOWED in Plan Mode').toBe(PolicyDecision.ALLOW);
                const cliHelpResult = await engine.check({ name: 'cli_help' }, undefined);
    ...
    describe('validateMcpPolicyToolNames', () => {
        ...
        it('should skip rules without toolName', () => {
            const warnings = validateMcpPolicyToolNames('my-server', ['tool1'], [{ toolName: undefined }]);
            expect(warnings).toHaveLength(0);
        });
