...
export async function injectAutomationOverlay(browserManager, signal) {
    try {
        ...
        const result = await browserManager.callTool('evaluate_script', { function: buildInjectionScript() }, signal);
        if (result.isError) {
...
export async function removeAutomationOverlay(browserManager, signal) {
    try {
        ...
        const result = await browserManager.callTool('evaluate_script', { function: buildRemovalScript() }, signal);
        if (result.isError) {
