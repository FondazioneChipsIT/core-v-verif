...
describe('setupUser', () => {
    ...
    describe('validation and errors', () => {
        it('should retry if validation handler returns verify', async () => {
            ...
            const result = await setupUser({}, mockHandler);
            expect(mockHandler).toHaveBeenCalledWith('https://verify', 'Verify please');
            expect(mockLoad).toHaveBeenCalledTimes(2);
        ...
        it('should throw ValidationCancelledError if handler returns cancel', async () => {
            ...
            await expect(setupUser({}, mockHandler)).rejects.toThrow(ValidationCancelledError);
        });
