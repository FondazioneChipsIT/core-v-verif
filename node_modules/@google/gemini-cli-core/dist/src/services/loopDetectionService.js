...
export class LoopDetectionService {
    ...
    addAndCheck(event) {
        ...
        if (isLoop) {
            ...
            logLoopDetected(this.config, new LoopDetectedEvent(this.lastLoopType, this.promptId, this.detectedCount));
        }
        return isLoop
            ? {
                count: this.detectedCount,
    ...
    async turnStarted(signal) {
        ...
        if (this.turnsInCurrentPrompt >= LLM_CHECK_AFTER_TURNS &&
            ...
            if (isLoop) {
                ...
                logLoopDetected(this.config, new LoopDetectedEvent(this.lastLoopType, this.promptId, this.detectedCount, confirmedByModel, analysis, LLM_CONFIDENCE_THRESHOLD));
                return {
                    count: this.detectedCount,
                    type: this.lastLoopType,
                    detail: this.lastLoopDetail,
