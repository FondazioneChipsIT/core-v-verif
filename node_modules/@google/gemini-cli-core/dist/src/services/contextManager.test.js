...
describe('ContextManager', () => {
    ...
    describe('refresh', () => {
        it('should load and format global and environment memory', async () => {
            ...
            expect(memoryDiscovery.readGeminiMdFiles).toHaveBeenCalledWith(expect.arrayContaining([...globalPaths, ...envPaths]), 'tree');
        ...
        it('should deduplicate files by file identity in case-insensitive filesystems', async () => {
            ...
            expect(memoryDiscovery.readGeminiMdFiles).toHaveBeenCalledWith(['/home/user/.gemini/GEMINI.md', '/app/gemini.md'], 'tree');
            expect(contextManager.getEnvironmentMemory()).toContain('Project Content');
        });
    });
    describe('discoverContext', () => {
        it('should discover and load new context', async () => {
            ...
            expect(memoryDiscovery.loadJitSubdirectoryMemory).toHaveBeenCalledWith('/app/src/file.ts', ['/app'], expect.any(Set), expect.any(Set));
